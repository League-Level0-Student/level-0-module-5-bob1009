...
public class EvilPolygonsChallenge {
	...
	public static void main(String[] args) {
		...
		jeff.setSpeed(100);
		int colorChoice=JOptionPane.showOptionDialog(null, "hello", "choose a color please", JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION, null, new String[]{"red","green", "blue"}, 0);
